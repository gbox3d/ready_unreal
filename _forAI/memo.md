...
- [제품 기준선](#제품-기준선)
- [기본 설정값](#기본-설정값)
- [MCP 등록 스코프 (핵심 개념)](#mcp-등록-스코프-핵심-개념)
- [CLI 레퍼런스 (claude mcp ...)](#cli-레퍼런스-claude-mcp-)
- [전역(user) 등록 — 한방 레시피 & 지시문 (재사용)](#전역user-등록--한방-레시피--지시문-재사용)
- [로딩 동작 (반드시 기억)](#로딩-동작-반드시-기억)
- [Toolset 게이트웨이 구조](#toolset-게이트웨이-구조)
- [동작 규칙](#동작-규칙)
- [반복 금지 (이번에 겪은 함정)](#반복-금지-이번에-겪은-함정)
